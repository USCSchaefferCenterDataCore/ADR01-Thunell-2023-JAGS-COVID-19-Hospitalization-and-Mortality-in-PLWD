...
data &tempwork..ffsptd_samp21;
	set base.samp_3yrffsptd_0621 (in=a keep=bene_id insamp2021 where=(insamp2021=1));
	by bene_id;
run;
...
%do year=&minyear. %to &maxyear.;
	...
	data &tempwork..&ctyp._&year._mo&mo.;
		...
		%end;
		&tempwork..ffsptd_samp21 (in=b);*merge;
		by bene_id;
		if a and b;
	run;
	%end;
	...
	data &tempwork..&ctyp._cci_ffsptd&year.;
		set &tempwork..&ctyp._&year._mo1-&tempwork..&ctyp._&year._mo4;
		by bene_id;
	run;
%end; 
...
data base.cci_ffsptd_bene21_janapr;
