...
data &outlib..ADdrugs_0619;
	format year best4. srvc_dt mmddyy10.;
	set &tempwork..pde:;
	by bene_id year srvc_dt;
run;                 

proc contents data=&outlib..ADdrugs_0619; run;
	
***** Creating date level part D file;
proc sql;
	create table &outlib..ADdrugs_dts_0619 as
...
***** Checks;
proc means data=&outlib..ADdrugs_dts_0619 noprint;
	class year;
...
proc freq data=&outlib..ADdrugs_dts_0619 noprint; table year*bene_id / out=&tempwork..bene_byyear; run;
