...
%macro combine_dts(typ,dropv=);
		...
		title2 dementia_dx_&typ._&minyear._&maxyear to dementia_dt_&typ._&minyear._&maxyear;

		data &tempwork..dementia_dt_&typ._&minyear._&maxyear.;
...
%do i=1 %to &max;
	...
	%do %while(%length(&phy)>0);
		proc transpose data=&&typ&i out=&phy (drop=_name_ _label_) prefix=&styp._&phy; 
			var &phy;
			by bene_id year demdx_dt;
		run;
...
data &tempwork..dementia_dt_&minyear._&maxyear._;
		
		merge &tempwork..dementia_dt_inpatient_&minyear._&maxyear 
			  &tempwork..dementia_dt_outpatient_&minyear._&maxyear
			  &tempwork..dementia_dt_snf_&minyear._&maxyear 
			  &tempwork..dementia_dt_hha_&minyear._&maxyear 
			  &tempwork..dementia_dt_carmrg_&minyear._&maxyear;
...
data &outlib..dementia_dt_&minyear._&maxyear.;
	...
	merge &tempwork..dementia_dt_&minyear._&maxyear._
				&tempwork..ip_phyv 
				&tempwork..carmrg_phyv 
				&tempwork..op_phyv 
				&tempwork..hha_phyv
				&tempwork..snf_phyv 
				&tempwork..carline_phyv ;
