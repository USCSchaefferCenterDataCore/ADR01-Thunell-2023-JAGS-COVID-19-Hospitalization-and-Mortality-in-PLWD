...
%let rifqmo=9; * Last Q available as of 3/29/22;
...
data &tempwork..telemod_2021;
	set &tempwork..telemod_bcarrier_2021_2021 &tempwork..telemod_hha_2021_2021 &tempwork..telemod_inpatient_2021_2021
	&tempwork..telemod_outpatient_2021_2021 &tempwork..telemod_snf_2021_2021;
	by bene_id year prcdr_dt clm_typ;
	month=month(prcdr_dt);
run;

proc means data=&tempwork..telemod_2021 noprint nway;
	class bene_id year month;
	var	hcpcs_mdfr95 hcpcs_mdfrGT pos02;
	output out=&tempwork..telemod_benemonth2021 sum()= max()= / autoname;
run;

data covid.telemod_benemonth2021;
	set &tempwork..telemod_benemonth2021;
run;

proc means data=&tempwork..telemod_2021 noprint nway;
	class year month;
	var	hcpcs_mdfr95 hcpcs_mdfrGT pos02;
	output out=&tempwork..telemod_month2021 sum()= mean()= / autoname;
run;
...
proc means data=&tempwork..telemod_2021 noprint nway;
	...
	class bene_id year month;
	var	hcpcs_mdfr95 hcpcs_mdfrGT pos02;
	output out=&tempwork..telemod_benemonth_carrier2021 sum()= max()= / autoname;
run;
