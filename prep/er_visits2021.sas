...
%macro phys(byear,eyear);
	...
	* Setting all together;
	data &tempwork..er_visits_2021;
		set &tempwork..er_ip&byear.
			&tempwork..er_op&byear.;
...
proc sort data=&tempwork..er_visits_2021 out=er_s_dt nodupkey; by bene_id clm_thru_dt clm_id; run;
...
proc sort data=&tempwork..er_visits_2021 out=er_s_clm nodupkey; by bene_id clm_id clm_thru_dt; run;
